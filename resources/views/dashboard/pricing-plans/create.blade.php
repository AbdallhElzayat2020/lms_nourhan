...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Create New Pricing Plan</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.pricing-plans.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                               name="name" value="{{ old('name') }}" required placeholder="e.g. Basic Plan">
                        @error('name')
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" id="price"
                               name="price" value="{{ old('price') }}" required placeholder="29.00">
                        @error('price')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control @error('price_period') is-invalid @enderror" id="price_period"
                               name="price_period" value="{{ old('price_period', '/Per month') }}" placeholder="/Per month">
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted d-block mt-1">Add features for this plan (e.g. Individual Course, Course Learning Checks)</small>
                </div>
