                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select class="form-select @error('course_type') is-invalid @enderror" id="course_type" name="course_type" required>
                                                <option value="both" {{ old('course_type', 'both') == 'both' ? 'selected' : '' }}>Both (Private & Live)</option>
                                                <option value="private" {{ old('course_type') == 'private' ? 'selected' : '' }}>Private</option>
                                                <option value="live" {{ old('course_type') == 'live' ? 'selected' : '' }}>Live</option>
                                            </select>
                                            @error('course_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('language') is-invalid @enderror" id="language" name="language"
                                                value="{{ old('language') }}" placeholder="e.g. English, Arabic">
                                            @error('language')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="section-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control summernote @error('about_program_text') is-invalid @enderror" id="about_program_text"
                                            name="about_program_text">{{ old('about_program_text') }}</textarea>
                                ...
                                <div class="section-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control summernote @error('how_course_works_text') is-invalid @enderror" id="how_course_works_text"
                                            name="how_course_works_text">{{ old('how_course_works_text') }}</textarea>
                                ...
                                <div class="section-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control summernote @error('what_you_achieve_text') is-invalid @enderror" id="what_you_achieve_text"
                                            name="what_you_achieve_text">{{ old('what_you_achieve_text') }}</textarea>
                                                ...
                                                <div class="faq-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faqs[]" value="{{ $faq->id }}" id="faq_{{ $faq->id }}"
                                                            {{ in_array($faq->id, old('faqs', [])) ? 'checked' : '' }}>
                            ...
                            <div class="section-card">
                                ...
                                <div class="section-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('meta_title') is-invalid @enderror" id="meta_title" name="meta_title"
                                            value="{{ old('meta_title') }}" placeholder="Leave empty to use course title">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description" name="meta_description"
                                            rows="3" placeholder="Leave empty to use short description">{{ old('meta_description') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('meta_keywords') is-invalid @enderror" id="meta_keywords" name="meta_keywords"
                                            rows="2" placeholder="Comma-separated keywords">{{ old('meta_keywords') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('schema_block') is-invalid @enderror"
                                              ...
                                              placeholder='{"@@context": "https://schema.org", "@type": "Course", "name": "Course Name", "provider": {"@type": "Organization", "name": "Nourhan Academy"}}'>{{ old('schema_block') }}</textarea>
