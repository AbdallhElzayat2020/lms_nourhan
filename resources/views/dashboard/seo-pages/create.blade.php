...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Dashboard / SEO Management /</span> Add New Page
        </h4>
        ...
        <div class="card">
            ...
            <form action="{{ route('admin.seo-pages.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="page_name" name="page_name"
                                class="form-control @error('page_name') is-invalid @enderror" value="{{ old('page_name') }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="page_title" name="page_title"
                                ...
                                value="{{ old('page_title') }}" placeholder="e.g., الصفحة الرئيسية" required>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" id="meta_title" name="meta_title"
                                    ...
                                    maxlength="60">
                                <div class="form-text">Recommended: 50-60 characters. <span
                                        id="meta-title-count">0</span>/60</div>
                                @error('meta_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Recommended: 150-160 characters. <span
                                        id="meta-desc-count">0</span>/160</div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="meta_keywords" name="meta_keywords" class="form-control @error('meta_keywords') is-invalid @enderror"
                                    rows="2" placeholder="keyword1, keyword2, keyword3">{{ old('meta_keywords') }}</textarea>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="schema_markup" name="schema_markup" class="form-control @error('schema_markup') is-invalid @enderror"
                                    rows="8" placeholder='{"@@context": "https://schema.org", "@type": "WebPage", "name": "Page Name"}'>{{ old('schema_markup') }}</textarea>
