...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.sliders.create') }}{{ request()->query() ? '?' . http_build_query(request()->query()) : '' }}" class="btn btn-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('admin.sliders.show', $slider->id) }}{{ request()->query() ? '?' . http_build_query(request()->query()) : '' }}"
                                            class="btn btn-sm btn-label-info">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.sliders.edit', $slider->id) }}{{ request()->query() ? '?' . http_build_query(request()->query()) : '' }}"
