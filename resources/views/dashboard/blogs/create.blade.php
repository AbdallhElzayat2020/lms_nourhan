                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('author') is-invalid @enderror" id="author" name="author"
                                                value="{{ old('author', 'Sister Nourhan') }}" placeholder="Sister Nourhan">
                                            @error('author')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                            ...
                            <div class="section-card">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('schema_block') is-invalid @enderror"
                                              ...
                                              placeholder='{"@@context": "https://schema.org", "@type": "Article", "headline": "Article Title", "author": {"@type": "Person", "name": "Sister Nourhan"}}'>{{ old('schema_block') }}</textarea>
