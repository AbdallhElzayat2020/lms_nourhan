    ...
    <section class="page-header">
        ...
        <div class="container">
            <div class="page-header-content">
                ...
                <a class="inner-page" href="{{ route('frontend.courses') }}"> Courses</a>
            </div>
        </div>
    </section>
    <!-- ./ page-header -->
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="courses-count mb-0">
                            @if ($courses->total() > 0)
                                ...
                                <strong>{{ $courses->lastItem() }}</strong> of <strong>{{ $courses->total() }}</strong>
                                courses
                            @else
                                No courses found
                            @endif
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="course-item wow fade-in-bottom" data-wow-delay="{{ 200 + ($index % 3) * 100 }}ms">
                                        ...
                                        <a href="{{ route('frontend.course.details', ['slug' => $course->slug]) }}">
                                            @if ($course->banner_image)
                                                <img src="{{ asset('uploads/courses/' . $course->banner_image) }}"
                                                    alt="{{ $course->title }}">
                                            @else
                                                <img src="{{ asset('assets/frontend/img/images/course-img-1.png') }}"
                                                    alt="{{ $course->title }}">
                                            @endif
                                        </a>
                                    </div>
                                ...
                                <div class="course-content">
                                    <h3 class="title">
                                        <a
                                            href="{{ route('frontend.course.details', ['slug' => $course->slug]) }}">{{ $course->title }}</a>
                                    </h3>
                                    @if ($course->subtitle)
